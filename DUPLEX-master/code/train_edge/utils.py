...
def undirected_label2directed_label(adj, edge_pairs, task, ratio):
    ...
    if task == 'train_di':
        ...
        print(f"Edge pairs after bi_edges: {bi_edges.shape}")#376
        new_edge_pairs = torch.cat((new_edge_pairs, bi_edges), dim=0)
        print(f"Edge pairs after new_edge_pairs: {new_edge_pairs.shape}")
    ...
    print(f"Edge pairs after conversion: {new_edge_pairs.shape}")
