...
from utils import predictor, fourClassLoss, edge_sampler
...
saveing_args = {
    ...
    'save_result_path':"../saveGraphEmbedding/%s/"%( args.dataset),
...
def main():
    ...
    for epoch in range(args.epochs): 
        ...
        if(epoch)%100 ==0:
            ...
            print("am_embedding:")
            print(am_embedding[0:10])  # Print the first 10 elements   
            print("ph_embedding:")
            print(ph_embedding[0:10])  # Print the first 10 elements   
        # ---------- print information -------
        if (epoch)%400 == 0:
